...
plot_network(df_map=DL_1998, map_title="Delta in 1998", point_color='blue', line_color='black')
plot_network(df_map=DL_2018, map_title='Delta in 2018', point_color='blue', line_color='black')

plot_network(df_map=AA_1998, map_title="American in 1998", point_color='red', line_color='black')
plot_network(df_map=AA_2018, map_title='American in 2018', point_color='red', line_color='black')

plot_network(df_map=WN_1998, map_title="Southwest in 1998", point_color='orange', line_color='black')
plot_network(df_map=WN_2018, map_title='Southwest in 2018', point_color='orange', line_color='black')

plot_network(df_map=UA_1998, map_title="United in 1998", point_color='yellow', line_color='black')
plot_network(df_map=UA_2018, map_title='United in 2018', point_color='yellow', line_color='black')
