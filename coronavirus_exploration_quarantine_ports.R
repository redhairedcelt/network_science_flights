...
plot_network(feb_grouped_covid, map_title = "Direct Routes from COVID-Designated Quarantine Ports to other Domestic Airports with at least 1 Daily Flight (Feb 2018)", point_color = "Red", map_fill = 'white', line_color = 'black')
...
plot(g_w, layout=layout_with_fr,  asp = 0, curved=T, 
     main="Quarantine Sites for Coronavirus and Connected Airports")
